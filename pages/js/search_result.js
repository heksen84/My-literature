		...
		{																
			...
			switch(obj.answer)
			{
				...
				{				
					...
					{					
					  $("#tbody").append("<tr data-id='"+item.id+"' class='table_item'><td>"+(i+1)+"</td><td><div class='title_cell'>"+item.title+"</div></td><td style='text-align:center'><div class='author_cell'>"+item.login+"</div></td><td><div class='like_cell'>0</div></td></tr>");					
					});
