...
<link href = "css/reader.css<?php include "php/debug.php"?>" 	rel	= "stylesheet"/>
<!-- libs -->
...
<script src = "js/reader.js<?php include "php/debug.php"?>"></script>
</head>
<!-- контейнер -->
<div class="container-fluid" id="reader_container">
<div class="row">
<div class="col-md-3">
<menu id="menu">
<li>Мои закладки</li>
