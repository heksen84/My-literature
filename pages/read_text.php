...
<link href = "css/read_text.css?<?php echo time()?>" 	rel	= "stylesheet"/>
<!-- libs -->
...
<script src = "js/read_text.js?<?php echo time()?>"></script>
</head>
<!-- контейнер -->
<div class="container">
<div class="row">
...
<div class="col-md-12 text-center" id="col-image"></div>
