...
<link href = "css/search_result.css<?php include "../php/debug.php"?>" 	rel = "stylesheet"/>
<!-- libs -->
...
<script src = "js/search_result.js<?php include "../php/debug.php"?>"></script>
</head>
<body>
...
<table class="table table-bordered table-hover table-sm" id="result_table">
  <thead>
    <tr>      
      ...
      <th style="width:20%;text-align:center">разместил</th>	  	  
